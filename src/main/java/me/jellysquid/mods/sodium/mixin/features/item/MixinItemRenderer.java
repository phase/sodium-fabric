...
public class MixinItemRenderer {
     ...
     */
    @Overwrite
    private void renderBakedItemModel(BakedModel model, ItemStack stack, int light, int overlay, PoseStack matrices, VertexConsumer vertices) {
     ...
     */
    @Overwrite
    private void renderBakedItemQuads(PoseStack matrices, VertexConsumer vertexConsumer, List<BakedQuad> quads, ItemStack stack, int light, int overlay) {
